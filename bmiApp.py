...
#ส่วนที่ 2 สร้างช่องรัลค่าน้ำหนัก และ ส่วนสูง
...
if st.button("คำนวนค่า BMI 🎯"):
  # แปลงส่วนสูงจาก cm เป็นเมตร แล้วคำนวน BMI
...
#ส่วนที่ 4 แปลผลค่า BMI ตามเกณฑ์
  if bmi < 18.5:
     st.warning("⚠️ คุณมีน้ำหนักอยู๋ในเกณฑ์ (ผอม)")
elif 18.5 <= bmi < 23.0:
    st.success("🎉คุณมีนเำหนักอยู่ในเกณฑ์ปกติ (สุขภาพดี)")
elif 23.0 <= bmi < 25.0:
...
st.divider()
st.write("นายราเมศวร์ ลุงตา เลขที่13 ม.4/13")
